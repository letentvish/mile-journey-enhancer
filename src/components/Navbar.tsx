  ...
  return (
    <header 
      className={cn(
        ...
        isScrolled ? "bg-mile-navy shadow-md py-2" : "bg-mile-navy py-4"
      )}
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center">
          <nav className="flex items-center rounded-full bg-opacity-20 bg-white/10 backdrop-blur-sm px-4 py-2 mr-4">
            ...
            <a href="#features" className="text-white hover:text-mile-gold transition-colors px-4 py-1">Our Solutions</a>
          ...
          <Button className="bg-mile-gold hover:bg-mile-gold/90 text-mile-navy font-medium rounded-full">
            Login
          </Button>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-mile-navy py-4 px-4 shadow-lg animate-fade-in">
          <nav className="flex flex-col space-y-4">
            <a 
              href="#" 
              className="text-white hover:text-mile-gold transition-colors py-2 border-b border-gray-700"
            ...
            <Button 
              className="bg-mile-gold hover:bg-mile-gold/90 text-mile-navy"
              onClick={() => setMobileMenuOpen(false)}
            >
              Login
            </Button>
